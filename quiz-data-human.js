    ...
    quizzes: {
        'bones': {
            ...
            items: [
                ...
                { name: 'Manubrium', x: 48.2, y: 17.4, smooth: 0.5, points: [[49.8, 18.2], [50.8, 17.9], [51.2, 17.3], [49.8, 16.6], [46.7, 16.5], [45.3, 17.3], [45.5, 17.8], [46.2, 18]] },
            ],
        },
        'joints': {
            ...
            items: [
                ...
                { name: 'Atlanto-occipital joint', x: 53, y: 13.4 },
                { name: 'Sternoclavicular joint', x: 51.1, y: 18 },
                { name: 'Sternocostal joints', x: 53.9, y: 22.1 },
                { name: 'Lumbosacral joint', x: 48.6, y: 41.5 },
                { name: 'Sacroiliac joint', x: 57.3, y: 42.6 },
                { name: 'Metacarpophalangeal joint', x: 80.9, y: 54.9 },
                { name: 'Metatarsophalangeal joint', x: 54.2, y: 96.6 },
            ],
        },
        'upper-limb-bones': {
        ...
        'upper-limb-joints': {
            ...
            items: [
                ...
                { name: 'Acromioclavicular joint', x: 32.5, y: 8.2 },
                { name: 'Proximal radioulnar joint', x: 49.1, y: 49.5 },
                { name: 'Distal radioulnar joint', x: 59.8, y: 71.7 },
            ],
        },
    },
};
