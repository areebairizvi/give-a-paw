    ...
    quizzes: {
        'bones': {
            ...
            items: [
                ...
                { name: 'Teeth', x: 17.2, y: 32.7, smooth: 0.5, points: [[21.1, 31.9], [20.7, 30.8], [20.5, 32.8], [18.7, 33.2], [19.5, 31.7], [17.7, 33.5], [18.9, 31.9], [16.2, 32.8], [16.2, 31.7], [17.3, 33.5], [16.1, 33.8], [14.1, 33.5], [14.5, 32.2], [14.5, 34.5], [15.2, 31.8], [14.6, 34.2]] },
            ],
        },
        'joints': {
            image: 'anatomy-dog-skeleton.svg', noun: 'joint',
            items: [
                { name: 'Temporomandibular joint', x: 25.5, y: 32 },
                { name: 'Shoulder joint', x: 40, y: 44 },
                { name: 'Elbow joint', x: 40.5, y: 58 },
                { name: 'Carpus (wrist)', x: 36.5, y: 78 },
                { name: 'Hip joint', x: 73, y: 45.5 },
                { name: 'Stifle (knee)', x: 70, y: 58.5 },
                { name: 'Hock (tarsus)', x: 80, y: 71 },
                { name: 'Atlanto-occipital joint', x: 26.6, y: 29.4 },
                { name: 'Atlantoaxial joint', x: 28.4, y: 32.5 },
                { name: 'Costovertebral joints', x: 44.7, y: 40 },
                { name: 'Sternocostal joints', x: 43.9, y: 53.5 },
                { name: 'Lumbosacral joint', x: 68.5, y: 35.2 },
                { name: 'Sacroiliac joint', x: 71.4, y: 38.2 },
                { name: 'Metacarpophalangeal joint', x: 38.4, y: 83.2 },
                { name: 'Metatarsophalangeal joint', x: 80.9, y: 82.5 },
                { name: 'Radioulnar joint', x: 38.9, y: 75.2 },
            ],
        },
        'thoracic-bones': {
            image: 'anatomy-thoracic-limb.png', noun: 'bone',
            items: [
                { name: 'Scapula', x: 46, y: 19, smooth: 0.6, points: [[52, 6], [60, 14], [59, 24], [52, 32], [44, 34], [38, 29], [41, 17], [46, 9]] },
                { name: 'Humerus', x: 47, y: 40 },
                { name: 'Radius', x: 40, y: 56 },
                { name: 'Ulna', x: 46, y: 54 },
                { name: 'Carpal bones', x: 43, y: 71 },
                { name: 'Metacarpal bones', x: 38, y: 79 },
                { name: 'Phalanges', x: 32, y: 86 },
            ],
        },
        'thoracic-joints': {
            image: 'anatomy-thoracic-limb.png', noun: 'joint',
            items: [
                { name: 'Shoulder joint', x: 41, y: 24 },
                { name: 'Elbow joint', x: 49, y: 46 },
                { name: 'Carpus (wrist)', x: 43, y: 70 },
                { name: 'Metacarpophalangeal joint', x: 35.5, y: 81.5 },
                { name: 'Proximal interphalangeal joint', x: 31.5, y: 85 },
                { name: 'Distal interphalangeal joint', x: 29, y: 87.5 },
                { name: 'Radioulnar joint', x: 43, y: 55 },
                { name: 'Carpometacarpal joint', x: 40.5, y: 75 },
            ],
        },
    },
};
